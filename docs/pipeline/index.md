...
> 本文档提取自官方 SDK `sdk/dev/car_pipeline_2.0rev/AC_Pipeline_PUB_Rev2.0.pdf`。
...
the right methods for the creation of community content. Again, we can only urge you to visit the
modding section of the official support forum to find information on Blender.

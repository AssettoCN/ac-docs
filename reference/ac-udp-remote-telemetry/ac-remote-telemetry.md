# AC Remote Telemetry Documentation（原始存档）

> **存档说明**
> - 作者：Giovanni Romagnoli（Kunos Simulazioni 程序员）
> - 原始出处：AC 官方遥测协议文档（Google Docs 发布版）
> - 发现渠道：[assettocorsamods.net 论坛帖 [DOC] AC UDP Remote Telemetry（2014-07-28）](https://assettocorsamods.net/threads/doc-ac-udp-remote-telemetry.60/)（本地存档：[thread-assettocorsamods.md](thread-assettocorsamods.md)）
> - 抓取日期：2026-09-11
> - 原始 URL：<https://docs.google.com/document/d/1KfkZiIluXZ6mMhLWfDX1qAGbvhGRC3ZUzjVIt5FQpp4/pub>
> - 正文按原样存档（保留原文拼写），仅恢复 HTML 提取时丢失的代码块换行。

---

This document helps you to set up UDP socket comunication between your application and Assetto Corsa. All the code samples are made using [http://codepad.org/](http://codepad.org/).
